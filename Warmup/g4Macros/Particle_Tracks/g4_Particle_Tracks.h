...
// Wed May 24 18:57:31 2023 by ROOT version 6.26/06
// from TTree event_tree/event tree
// found on file: /scratch/user/eikenbcr/DUNE/Warmup/muon.root
//////////////////////////////////////////////////////////

#ifndef g4_Particle_Tracks_h
#define g4_Particle_Tracks_h
...
class g4_Particle_Tracks : public TSelector {
public :
   ...
   g4_Particle_Tracks(TTree * /*tree*/ =0) { }
   virtual ~g4_Particle_Tracks() { }
   ...
   ClassDef(g4_Particle_Tracks,0);

};

#endif

#ifdef g4_Particle_Tracks_cxx
void g4_Particle_Tracks::Init(TTree *tree)
{
...
Bool_t g4_Particle_Tracks::Notify()
{
...
#endif // #ifdef g4_Particle_Tracks_cxx
