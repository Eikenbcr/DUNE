...
// Tue May 16 14:34:36 2023 by ROOT version 6.26/06
// from TTree event_tree/event tree
// found on file: muon.root
//////////////////////////////////////////////////////////

#ifndef PDFsaver_Muon10GeV_h
#define PDFsaver_Muon10GeV_h
...
class PDFsaver_Muon10GeV : public TSelector {
public :
   ...
   PDFsaver_Muon10GeV(TTree * /*tree*/ =0) { }
   virtual ~PDFsaver_Muon10GeV() { }
   ...
   ClassDef(PDFsaver_Muon10GeV,0);

};

#endif

#ifdef PDFsaver_Muon10GeV_cxx
void PDFsaver_Muon10GeV::Init(TTree *tree)
{
...
Bool_t PDFsaver_Muon10GeV::Notify()
{
...
#endif // #ifdef PDFsaver_Muon10GeV_cxx
