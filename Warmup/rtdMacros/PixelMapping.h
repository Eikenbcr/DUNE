...
// Tue May 23 17:22:14 2023 by ROOT version 6.26/06
...
class PixelMapping : public TSelector {
public :
   ...
   PixelMapping(TTree * /*tree*/ =0) { }
   virtual ~PixelMapping() { }
   ...
   ClassDef(PixelMapping,0);

};

#endif

#ifdef PixelMapping_cxx
void PixelMapping::Init(TTree *tree)
{
