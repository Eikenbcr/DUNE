...
Pixel_Reset_1 = new TH1D("qpixrtd events", "Pixel 1 Reset Frequency", 18000, 200, 2000);
Pixel_Reset_1->GetXaxis()->SetTitle("time (#mus)");
Pixel_Reset_1->GetYaxis()->SetTitle("Resets / (0.1 #mus)");
   
Pixel_Reset_2 = new TH1D("qpixrtd events", "Pixel 2 Reset Frequency", 18000, 200, 2000);
Pixel_Reset_2->GetXaxis()->SetTitle("time (#mus)");
Pixel_Reset_2->GetYaxis()->SetTitle("Resets / (0.1 #mus)");   
   
Pixel_Reset_3 = new TH1D("qpixrtd events", "Pixel 3 Reset Frequency", 18000, 200, 2000);
Pixel_Reset_3->GetXaxis()->SetTitle("time (#mus)");
Pixel_Reset_3->GetYaxis()->SetTitle("Resets / (0.1 #mus)");      
   
Pixel_Reset_4 = new TH1D("qpixrtd events", "Pixel 4 Reset Frequency", 18000, 200, 2000);
...
double PR1L =  Pixel_Reset_1->GetMean() - 1;
double PR1H =  Pixel_Reset_1->GetMean() + 1;   
double PR2L =  Pixel_Reset_2->GetMean() - 1;
double PR2H =  Pixel_Reset_2->GetMean() + 1; 
double PR3L =  Pixel_Reset_3->GetMean() - 1;
double PR3H =  Pixel_Reset_3->GetMean() + 1;      
double PR4L =  Pixel_Reset_4->GetMean() - 1;
double PR4H =  Pixel_Reset_4->GetMean() + 1;      
double PR5L =  Pixel_Reset_5->GetMean() - 1;
double PR5H =  Pixel_Reset_5->GetMean() + 1;      
...
Pixel_Reset_1->GetXaxis()->SetRange(PR1L,PR1H);
Pixel_Reset_1->Draw();
...
Pixel_Reset_2->GetXaxis()->SetRange(PR2L,PR2H);
Pixel_Reset_2->Draw();
...
Pixel_Reset_3->GetXaxis()->SetRange(PR3L,PR3H);   
Pixel_Reset_3->Draw();  
...
Pixel_Reset_4->GetXaxis()->SetRange(PR4L,PR4H);
Pixel_Reset_4->Draw();   
...
Pixel_Reset_5->GetXaxis()->SetRange(PR5L,PR5H);      
Pixel_Reset_5->Draw();
