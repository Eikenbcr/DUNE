...
// Fri May 26 16:22:04 2023 by ROOT version 6.26/06
// from TTree event_tree/event tree
// found on file: /scratch/user/eikenbcr/DUNE/Warmup/muon_rtd.root
//////////////////////////////////////////////////////////

#ifndef PixelResetTime_h
#define PixelResetTime_h
...
class PixelResetTime : public TSelector {
public :
   ...
   PixelResetTime(TTree * /*tree*/ =0) { }
   virtual ~PixelResetTime() { }
   ...
   ClassDef(PixelResetTime,0);

};

#endif

#ifdef PixelResetTime_cxx
void PixelResetTime::Init(TTree *tree)
{
...
#endif // #ifdef PixelResetTime_cxx
